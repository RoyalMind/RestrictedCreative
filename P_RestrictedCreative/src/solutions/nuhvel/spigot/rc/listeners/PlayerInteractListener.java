...
public class PlayerInteractListener implements Listener {
	...
	public PlayerInteractListener(RestrictedCreative restrictedCreative) {
	...
	public void onPlayerInteractHighest(PlayerInteractEvent e) {
		...
		if (CommandHandler.isInfoWithCommand(p)) {
			if (BlockHandler.isTracked(b)) {
				Utils.sendMessage(p, getMain().getUtils().getFormattedMessage(true, "block.info.true")
						.replaceAll("%material%", b.getType().toString()));
			} else {
				Utils.sendMessage(p, getMain().getUtils().getFormattedMessage(true, "block.info.false")
						.replaceAll("%material%", b.getType().toString()));
			}
			...
			Utils.sendMessage(p, getMain().getUtils().getFormattedMessage(true, "block.add.added")
					.replaceAll("%material%", b.getType().toString()));
			...
			Utils.sendMessage(p, getMain().getUtils().getFormattedMessage(true, "block.remove.removed")
					.replaceAll("%material%", b.getType().toString()));
		}
